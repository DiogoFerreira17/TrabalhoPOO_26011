...
namespace GereHospital
{
    ...
    public class InOut
    {
        ...
        public static void HistoricoPaciente(int nus, List<Consulta> consultas,List<Exame>exames,List<Diagnostico>diagnosticos,List<Cirurgia>cirurgias,List<Internamento>internamentos)
        {
            ImprimirConsultasPorPaciente(consultas, nus);
            ImprimirExamesPorPaciente(exames, nus);
            ImprimirDiagnosticosPorPaciente(diagnosticos, nus);
            ImprimirCirurgiasPorPaciente(cirurgias, nus);
            ImprimirInternamentosPorPaciente(internamentos, nus);
        }
